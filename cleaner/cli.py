"""Command-line interface: clean a messy CSV.

    clean-csv <input.csv> [output.csv] [--llm]

Uses the offline rule-based planner by default. Pass --llm to use an LLM planner instead
